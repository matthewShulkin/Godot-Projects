...
onready var remoteTransform2D: = $RemoteTransform2D
 ...
 #func powerup(): # try working on this after you finished your other stuff 
	#moveData = load("res://FastPlayerMovementData.tres")
		
#func _ready(): this isnt working but I can work on this later
...
func move_state(input, delta):
	...
	if not horizontal_move(input): #not attempting to move/slowing down/ if we are not moving horizontally
...
func is_on_ladder(): # use this for how to make powerup
